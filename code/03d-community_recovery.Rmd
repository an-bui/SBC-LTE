...
ggpredict(linear_model_algae_lmer, terms = "time_since_end [4.6:4.7 by = 0.001]", type = "fixed")

# lower bound of 95% conf int: 2.6 years
ggpredict(linear_model_algae_lmer, terms = "time_since_end [2.6:2.7 by = 0.001]", type = "fixed")

# upper bound of 95% conf int: 7.7 years
ggpredict(linear_model_algae_lmer, terms = "time_since_end [7.6:7.7 by = 0.001]", type = "fixed")
...
# check
plot(simulateResiduals(linear_model_invert_lmer_during))
check_model(linear_model_invert_lmer_during)
