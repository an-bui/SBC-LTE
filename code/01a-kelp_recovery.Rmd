...
ggsave(here::here("figures", paste("fig1_", todays_date, ".jpg", sep = "")), plot = biomass_by_season_annual_v2, height = 8, width = 8, dpi = 150)
...
ggsave(here::here("figures", paste("fig2_", todays_date, ".jpg", sep = "")), plot = fig2_v2, height = 8, width = 16, dpi = 150)
```
