...
## b. average raw biomass after 3.7 years
...
#                   paste("delta_continual_sites_raw-", today(), ".jpg", sep = "")), 
...
ggpredict(linear_model_kelp_lmer, terms = "time_since_end [3.2:3.4 by = 0.01]", type = "random", condition = c(site = "carp"))
...
#### recovery time vs kelp biomass in control
...
```{r}
# AQUE: kelp year 2021-2022
# 3.80 |      1.27 | [-674.27, 676.81]
# Naples: kelp year 2019-2020
# 3.42 |      1.67 | [-672.08, 675.42]
# Mohawk: 2021-2022
# 5.40 |      0.40 | [-688.62, 689.42]
# CArp: 2020-2021
# 3.33 |      1.10 | [-672.28, 674.48]
...
ggsave(here::here("figures", paste("recovery_time-", today(), ".jpg", sep = "")), plot = rec_time_plot, height = 8, width = 10, dpi = 150)
```
