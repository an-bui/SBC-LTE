...
aque_kelp_timeseries <- delta_frond_timeseries_fxn("AQUE")
mohk_kelp_timeseries <- delta_frond_timeseries_fxn("MOHK")
carp_kelp_timeseries <- delta_frond_timeseries_fxn("CARP")
ivee_kelp_timeseries <- ggplot() +
  ...
  labs(title = "IVEE",
       x = "Sampling date",
       y = " ")
napl_kelp_timeseries <- delta_frond_timeseries_fxn("NAPL")
...
```{r}
aque_kelp_timeseries_labs <- aque_kelp_timeseries +
  labs(x = "Sampling date", y = "Delta fronds (removal - control)")
mohk_kelp_timeseries_labs <- mohk_kelp_timeseries +
  labs(x = "Sampling date", y = "Delta fronds (removal - control)")
ivee_kelp_timeseries_labs <- ivee_kelp_timeseries +
  labs(x = "Sampling date", y = "Delta fronds (removal - control)")
napl_kelp_timeseries_labs <- napl_kelp_timeseries +
  labs(x = "Sampling date", y = "Delta fronds (removal - control)")
carp_kelp_timeseries_labs <- carp_kelp_timeseries +
  labs(x = "Sampling date", y = "Delta fronds (removal - control)")
```
