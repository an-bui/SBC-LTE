...
total_frond_timeseries_fxn <- function(site_choice) {
  ...
  ggplot(data = total_fronds %>% filter(site == site_choice),
    ...
    geom_line(size = 1) +
    scale_color_manual(values = c("ANNUAL" = annual_col, "CONTINUAL" = continual_col, "CONTROL" = "grey")) +
    scale_shape_manual(values = c("ANNUAL" = annual_shape, "CONTINUAL" = continual_shape, "CONTROL" = 21))  +
    theme_bw() + 
...
aque_delta_kelp_timeseries_labs <- aque_delta_kelp_timeseries +
  labs(x = "Sampling date", y = "\u0394 fronds (removal - control)",
...
# ggsave(here::here("figures", "panels_aque_2022-02-03.jpg"), aque_panels, height = 10, width = 9, dpi = 200)
# 
# ggsave(here::here("figures", "panels_napl_2022-02-03.jpg"), napl_panels, height = 10, width = 9, dpi = 200)
# 
# ggsave(here::here("figures", "panels_ivee_2022-02-03.jpg"), ivee_panels, height = 10, width = 9, dpi = 200)
# 
# ggsave(here::here("figures", "panels_carp_2022-02-03.jpg"), carp_panels, height = 10, width = 9, dpi = 200)
# 
# ggsave(here::here("figures", "panels_mohk_2022-02-03.jpg"), mohk_panels, height = 10, width = 9, dpi = 200)
```
