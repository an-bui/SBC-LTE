...
df <- biomass %>% 
  ...
  mutate(delta_annual_during = control_during - annual_during,
         delta_continual_during = control_during - continual_during,
         # "rise" is the increase after the experiment ends (difference between after and during)
         rise_annual = annual_after - annual_during,
         rise_continual = continual_after - continual_during,
         # impact is the ratio of delta:control biomass
         impact_annual = delta_annual_during/control_during,
         impact_continual = delta_continual_during/control_during,
         # extent is the ratio of rise:delta
         extent_annual = rise_annual/delta_annual_during,
         extent_continual = rise_continual/delta_continual_during,
         delta_annual_after = control_after - annual_after,
         delta_continual_after = control_after - continual_after
  )
