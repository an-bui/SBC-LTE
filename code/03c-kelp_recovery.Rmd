...
delta_biomass <- kelp_biomass %>% 
  select(site, year, month, treatment, date, exp_dates, dry_gm2) %>% 
...
delta_annual <- delta_biomass %>% 
  select(site, year, month, date, control, annual, delta_annual) %>% 
  ...
  mutate(kelp_year = paste("kelp_", kelp_year, sep = "")) %>% 
  # create a column for the points to compare for "2 year interval"
  mutate(comp_2yrs = case_when(
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2008", "kelp_2009") ~ "start",
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2015", "kelp_2016") ~ "during", 
    site == "ivee" & kelp_year %in% c("kelp_2011", "kelp_2012") ~ "start",
    site == "ivee" & kelp_year %in% c("kelp_2015", "kelp_2016") ~ "during",
    kelp_year %in% c("kelp_2020", "kelp_2021") ~ "after"
  )) %>% 
  ...
  mutate(comp_3yrs = case_when(
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2008", "kelp_2009", "kelp_2010") ~ "start",
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2014", "kelp_2015", "kelp_2016") ~ "during", 
    site == "ivee" & kelp_year %in% c("kelp_2011", "kelp_2012", "kelp_2013") ~ "start",
    site == "ivee" & kelp_year %in% c("kelp_2014", "kelp_2015", "kelp_2016") ~ "during",
    kelp_year %in% c("kelp_2019", "kelp_2020", "kelp_2021") ~ "after"
  )) %>% 
  mutate(comp_3yrs = fct_relevel(comp_3yrs, "start", "during", "after"))

delta_continual <- delta_biomass %>% 
  select(site, year, month, date, control, annual, delta_continual) %>% 
  ...
  # create a column for the points to compare for "2 year interval"
  mutate(comp_2yrs = case_when(
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2010", "kelp_2011") ~ "start",
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2015", "kelp_2016") ~ "during", 
    site == "ivee" & kelp_year %in% c("kelp_2011", "kelp_2012") ~ "start",
    site == "ivee" & kelp_year %in% c("kelp_2015", "kelp_2016") ~ "during",
    kelp_year %in% c("kelp_2020", "kelp_2021") ~ "after"
  ...
  # create a column for the points to compare for "3 year interval"
  mutate(comp_3yrs = case_when(
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2010", "kelp_2011", "kelp_2012") ~ "start",
    site %in% c("aque", "napl", "mohk", "carp") & kelp_year %in% c("kelp_2014", "kelp_2015", "kelp_2016") ~ "during", 
    site == "ivee" & kelp_year %in% c("kelp_2011", "kelp_2012", "kelp_2013") ~ "start",
    site == "ivee" & kelp_year %in% c("kelp_2014", "kelp_2015", "kelp_2016") ~ "during",
    kelp_year %in% c("kelp_2019", "kelp_2020", "kelp_2021") ~ "after"
