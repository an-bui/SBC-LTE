...
sites_annual_slope_summary <- enframe(sites_annual_slope) %>% 
  ...
  tab_header(
    title = "Annual removal slopes"
  ) 

sites_annual_slope_summary %>% 
  gtsave("annual_removal_slopes.png", path = here::here("tables"))
...
sites_continual_slope_summary <- enframe(sites_continual_slope) %>% 
  ...
  tab_header(
    title = "Continual removal slopes"
  ) 

sites_continual_slope_summary %>% 
  gtsave("continual_removal_slopes.png", path = here::here("tables"))
