...
ggplot(bc_continual_plotdf, aes(x = NMDS1, y = NMDS2)) +
  coord_cartesian() +
  geom_point(aes(col = comp_2yrs, shape = site, alpha = treatment), size = 3) +
...
prop_epi_inverts_biomass %>% 
  ...
  labs(x = "",
       y = "Percent biomass",
       title = "Sessile epilithic inverts") +
  theme_bw() +
  theme(panel.grid = element_blank(),
        axis.text = element_text(size = 16),
        axis.title = element_text(size = 18),
